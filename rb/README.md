...
The Ruby SDK for the Keyval API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `KeyvalError` (a `StandardError` subclass), so wrap
...
The main module (`Keyval_sdk`) exports the SDK class
