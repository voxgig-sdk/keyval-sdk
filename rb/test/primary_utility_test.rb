...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = KeyvalOmni.make_runner(TEST_JSON_FILE, KeyvalSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : KeyvalOmni.errify(err)
    end
