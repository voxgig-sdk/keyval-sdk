...
module KeyvalTestRunner
  ...
  def self.env_override(m)
    live = getenv("KEYVAL_TEST_LIVE")
    override = getenv("KEYVAL_TEST_OVERRIDE")
    ...
    explain = getenv("KEYVAL_TEST_EXPLAIN")
    m["KEYVAL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = KeyvalTestRunner
Helpers = KeyvalHelpers
Vs = VoxgigStruct
