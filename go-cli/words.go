...
func registerSDKWords(r *eng.Registry, client *sdk.KeyvalSDK) {
...
func runOp(client *sdk.KeyvalSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
