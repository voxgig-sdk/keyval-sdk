...
describe("KeyValueOperationDirect", function()
  it("should direct-load-key_value_operation", function()
    local setup = key_value_operation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-key_value_operation", setup.live and "live" or "unit")
...
function key_value_operation_direct_setup(mockres)
