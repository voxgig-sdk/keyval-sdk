...
describe("NtDirect", function()
  it("should direct-load-nt", function()
    local setup = nt_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nt", setup.live and "live" or "unit")
...
function nt_direct_setup(mockres)
