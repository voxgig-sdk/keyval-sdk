...
func NewNtEntity(client *core.KeyvalSDK, entopts map[string]any) *NtEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NtEntity) GetName() string { return e.name }
...
func (e *NtEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NtEntity) Deleted() bool {
	return e.deleted
}


func (e *NtEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNtEntity(e.client, opts)
}

func (e *NtEntity) Data(args ...any) any {
...
func (e *NtEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nt; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NtEntity) DataTyped(data ...Nt) Nt {
	if len(data) > 0 {
		return typedFrom[Nt](e.Data(asMap(data[0])))
	}
	return typedFrom[Nt](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nt (all fields
// optional at the wire level).
func (e *NtEntity) MatchTyped(match ...Nt) Nt {
	if len(match) > 0 {
		return typedFrom[Nt](e.Match(asMap(match[0])))
	}
	return typedFrom[Nt](e.Match())
}
...
func (e *NtEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NtEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NtLoadMatch and returns an Nt. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NtEntity) LoadTyped(reqmatch NtLoadMatch, ctrl map[string]any) (Nt, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Nt{}, err
	}
	return typedFrom[Nt](res), nil
}



func (e *NtEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NtEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NtEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NtEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NtEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
