...
func (sdk *KeyvalSDK) OptionsMap() map[string]any {
...
func (sdk *KeyvalSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KeyvalSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KeyvalSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KeyvalSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KeyvalSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KeyvalSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KeyvalSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KeyvalSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KeyvalSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KeyvalSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
