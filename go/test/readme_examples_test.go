...
const testSeed = `map[string]any{"entity": map[string]any{"key_value_operation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "nt": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
