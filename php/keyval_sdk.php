...
class KeyvalSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = KeyvalHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = KeyvalHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!KeyvalFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, KeyvalFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return KeyvalUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = KeyvalHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = KeyvalHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = KeyvalHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new KeyvalError($op . "_allow",
                "KeyvalSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = KeyvalHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new KeyvalError("graphql_error",
                "KeyvalSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function KeyValueOperation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_key_value_operation === null) {
                $this->_key_value_operation = new KeyValueOperationEntity($this, null);
            }
            return $this->_key_value_operation;
        }
        return new KeyValueOperationEntity($this, $data);
    }
    ...
    public function Nt($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_nt === null) {
                $this->_nt = new NtEntity($this, null);
            }
            return $this->_nt;
        }
        return new NtEntity($this, $data);
    }
