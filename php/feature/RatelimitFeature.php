...
class KeyvalRatelimitFeature extends KeyvalBaseFeature
{
    ...
    private function _acquire(KeyvalContext $ctx): void
    {
    ...
    private function _track(KeyvalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
