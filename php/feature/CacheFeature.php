...
class KeyvalCacheFeature extends KeyvalBaseFeature
{
    ...
    private function _through(KeyvalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
