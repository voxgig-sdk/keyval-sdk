...
class NtDirectTest extends TestCase
{
    public function test_direct_load_nt(): void
    {
        $setup = nt_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-nt", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
