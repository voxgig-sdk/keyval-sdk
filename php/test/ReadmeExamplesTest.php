...
// Keyval SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KeyvalSDK::test)
...
{
    private const SDK_CLASS = 'KeyvalSDK';
    ...
    private const SDK_BASE = 'keyval_sdk';
