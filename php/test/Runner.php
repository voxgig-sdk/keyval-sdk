...
class KeyvalTestRunner
{
    ...
    {
        $live = self::getenv('KEYVAL_TEST_LIVE');
        $override = self::getenv('KEYVAL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('KEYVAL_TEST_EXPLAIN');
...
class_alias('KeyvalTestRunner', 'Runner');
class_alias('KeyvalHelpers', 'Helpers');
