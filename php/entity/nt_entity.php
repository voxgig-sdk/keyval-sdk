...
class NtEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NtEntity($this->_client, $opts);
    }

    /**
     * @param Nt|array $args Nt data (assoc-array) to store.
     */
    ...
    /**
     * @return Nt|array The current Nt data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Nt fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Nt fields).
     */
     ...
     * Load a single Nt.
     *
     * @param NtLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NtLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Nt|array The loaded Nt as an assoc-array at the
