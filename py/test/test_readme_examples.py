# Keyval SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KeyvalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KeyvalSDK(...) and KeyvalSDK.test(...) become
#      KeyvalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "keyval_sdk"
_SDK_CLASS = "KeyvalSDK"
...
_ENTITIES = {
    "KeyValueOperation": "key_value_operation",
    "Nt": "nt",
}
