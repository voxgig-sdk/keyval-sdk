...
from keyval_sdk.utility.voxgig_struct import voxgig_struct as vs
from keyval_sdk import KeyvalSDK
from keyval_sdk.core.spec import KeyvalSpec
from keyval_sdk.core.result import KeyvalResult
from keyval_sdk.core.response import KeyvalResponse
from keyval_sdk.core.operation import KeyvalOperation
from keyval_sdk.core.error import KeyvalError
from keyval_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = KeyvalSDK.test(None, None)
        ...
        class TestInitFeature(KeyvalBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(KeyvalBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = KeyvalSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = KeyvalSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = KeyvalSDK.test(None, setup_opts)
