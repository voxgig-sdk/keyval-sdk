...
from keyval_sdk.utility import register

# Load features
from keyval_sdk.feature.base_feature import KeyvalBaseFeature
from keyval_sdk.features import _has_feature, _make_feature
...
class KeyvalSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = KeyvalUtility()
        self._utility = utility

        from keyval_sdk.config import shared_config
    ...
    def get_utility(self):
        return KeyvalUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KeyvalSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def KeyValueOperation(self, data=None) -> "KeyValueOperationEntity":
        ...
        from keyval_sdk.entity.key_value_operation_entity import KeyValueOperationEntity
        return KeyValueOperationEntity(self, data)


    def Nt(self, data=None) -> "NtEntity":
        """Entity factory: client.Nt().list() / client.Nt().load({"id": ...})."""
        from keyval_sdk.entity.nt_entity import NtEntity
