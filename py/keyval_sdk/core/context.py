...
from keyval_sdk.core.control import KeyvalControl
...
from keyval_sdk.core.helpers import get_ctx_prop, to_map
...
class KeyvalContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, KeyvalResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KeyvalError(code, msg, self)
