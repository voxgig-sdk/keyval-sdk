...
type Args struct {
	Entity string         `json:"entity" jsonschema:"key_value_operation | nt"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KeyvalSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "keyval_list",
		Description: "List records from Keyval. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "keyval_load",
		Description: "Load a single record from Keyval. " +
...
func runOp(client *sdk.KeyvalSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KeyvalSDK, name string) (sdk.KeyvalEntity, error) {
	switch strings.ToLower(name) {
	case "key_value_operation":
		return client.KeyValueOperation(nil), nil
	case "nt":
		return client.Nt(nil), nil
