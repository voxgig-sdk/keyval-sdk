...
class KeyvalTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KeyvalTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = KeyvalTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = KeyvalTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
...
def entity_data(v):
    return KeyvalTestRunner.entity_data(v)
...
def live_client_options():
    return KeyvalTestRunner.live_client_options()
