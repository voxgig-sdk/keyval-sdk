...
class KeyvalStreamingFeature extends KeyvalBaseFeature
{
    ...
    private function _iterate(KeyvalResult $result): \Generator
    {
    ...
    private function _streamable(KeyvalContext $ctx): bool
    {
