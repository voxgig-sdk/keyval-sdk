...
// Keyval SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KeyvalTestFeature extends KeyvalBaseFeature
{
    ...
    public function init(KeyvalContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KeyvalContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KeyvalContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KeyvalContext $ctx, $op, $args): array
    {
