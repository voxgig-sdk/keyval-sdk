...
class KeyvalProxyFeature extends KeyvalBaseFeature
{
    ...
    public function init(KeyvalContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KeyvalContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
