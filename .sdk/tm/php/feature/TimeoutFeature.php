...
class KeyvalTimeoutFeature extends KeyvalBaseFeature
{
    ...
    private function _with_timeout(KeyvalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KeyvalContext $_ctx, float $ms): void
    {
        $client = $this->client;
