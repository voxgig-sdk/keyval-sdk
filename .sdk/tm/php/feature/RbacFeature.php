...
class KeyvalRbacFeature extends KeyvalBaseFeature
{
    ...
    private function _required(KeyvalContext $ctx): ?string
    {
    ...
    private function _reject(KeyvalContext $ctx, string $required): void
    {
    ...
    private function _track(KeyvalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
