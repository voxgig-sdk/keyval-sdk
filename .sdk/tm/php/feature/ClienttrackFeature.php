...
// Keyval SDK clienttrack feature
...
class KeyvalClienttrackFeature extends KeyvalBaseFeature
{
    ...
    public function PostConstruct(KeyvalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Keyval-SDK';
