...
// Keyval SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KeyvalMakeRequest
{
    public static function call(KeyvalContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KeyvalResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KeyvalResponse($fetched);
        } else {
