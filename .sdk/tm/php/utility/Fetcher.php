...
class KeyvalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KeyvalSDK/1.0)';
    ...
    public static function call(KeyvalContext $ctx, string $fullurl, array $fetchdef): array
    {
