...
// Keyval SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KeyvalOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KeyvalOmni::structfix($now, Struct::undef()))
                        !== json_encode(KeyvalOmni::structfix($val, Struct::undef()))) {
