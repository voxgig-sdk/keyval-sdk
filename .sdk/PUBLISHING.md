...
|---|---|---|
| `ts/` | @voxgig-sdk/keyval-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/keyval-sdk \
      --repository voxgig-sdk/keyval-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/keyval-sdk` shows it, and
`npm trust revoke @voxgig-sdk/keyval-sdk --id=<id>` removes it.
