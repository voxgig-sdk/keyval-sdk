...
(0, node_test_1.describe)('KeyValueOperationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-key_value_operation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-key_value_operation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.KEYVAL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KeyvalSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KEYVAL_TEST_KEY_VALUE_OPERATION_ENTID'];
    ...
    const client = new __1.KeyvalSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=KeyValueOperationDirect.test.js.map